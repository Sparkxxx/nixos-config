{
  ...
  users.users."${myvars.username}" = {
    ...
    # we have to use initialHashedPassword here when using tmpfs for / (123qwe)
    initialHashedPassword = "$7$CU..../....VEyHalaGoBgu4NMmDqDKe/$/iWDUnUZ.fbkqPEgFlIPZMpEws1MxMkl3RWbOl7XS8C";
